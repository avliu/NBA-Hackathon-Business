...
#     return count
#
# dataset = 'holdout_set_same'
#
# df_instagram_usernames = pd.read_csv('text_processing/instagram_usernames.csv', index_col=0)
# df_instagram_usernames.index = map(str.lower, df_instagram_usernames.index)
# df_instagram_followers = pd.read_csv('text_processing/instagram_followers_4.csv', index_col=0)
#
...
#             break
#
# df_instagram_followers.to_csv('text_processing/instagram_followers_5.csv')
# df_instagram_stats.to_csv(f'text_processing/{dataset}_stats_1.csv')
